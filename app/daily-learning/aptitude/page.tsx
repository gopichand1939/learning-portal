      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              Aptitude - 30 Days Program
            </h1>
            <p className="mt-2 text-gray-600">
              Select a day to start your aptitude learning
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6">
          {days.map((day) => (
            <Link
              key={day}
              href={`/daily-learning/aptitude/day-${day}`}
            ...
            >
              <div className="mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 group-hover:bg-blue-200">
