      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              Verbal Ability - 30 Days Program
            </h1>
            <p className="mt-2 text-gray-600">
              Select a day to start your verbal ability learning
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6">
          {days.map((day) => (
            <Link
              key={day}
              href={`/daily-learning/verbal/day-${day}`}
            ...
            >
              <div className="mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-purple-100 group-hover:bg-purple-200">
